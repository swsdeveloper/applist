...
with col2:
    ...
    content = """Hi! I am Steven and I have had a long and varied career where I've worked for large corporations
    ...
    content2 = """I work closely with my customers to deliver the features and solutions they need. This includes
